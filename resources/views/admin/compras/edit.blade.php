        ...
        <div class="card-header">
            ...
            <div class="card-body">
                ...
                <form action="{{url('/admin/compras', $compra->id) }}" id="form_compra"method="post">
                        @csrf
                        @method('PUT')
                        <input type="text" value="{{$compra->id}}" id="id_compra" name="id_compra">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" value="{{$compra->laboratorio->nombre}}"id="nombre_laboratorio" >
                                        <input type="text" class="form-control" id="id_laboratorio" value="{{$compra->laboratorio->id}}" name="laboratorio_id" hidden>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="comprobante" id="comprobante" value="{{$compra->comprobante}}"class="form-control">
...
$('.delete-btn').click(function () {
    ...
    if (id) {
        $.ajax({
            url: "{{url('/admin/compras/detalle')}}/"+id, // Se corrigió el uso de route()
            type: 'POST',
            data: {
