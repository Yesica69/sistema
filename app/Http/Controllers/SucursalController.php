...
class SucursalController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $usuario->sucursal_id = $sucursal->id; // Asegúrate de que $sucursal esté definido y válido
        $usuario->save();
        
        $usuario->assignRole('ADMINISTRADOR');//asignar el rol aministrador en la tablaa
